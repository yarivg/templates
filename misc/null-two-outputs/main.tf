...
output "fargate_profiles_non_empty" {
  value = {
    "default" = {
      "cluster_name" = "nequi-prod-use1"
      "fargate_profile_name" = "default"
      "pod_execution_role_arn" = "arn:aws:iam::390403873886:role/eksctl-nequi-prod-use1-nodegroup-default-FargatePodExecutionRole-1JZQJZQZQZQZQ"
      "subnets" = [
